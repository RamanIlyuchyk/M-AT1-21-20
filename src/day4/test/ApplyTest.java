...
public class ApplyTest {
    ...
    public void manualTestPassed() {
        ...
        Assert.assertEquals("Manual test by automation engineer with UNIT(1), instability 2, anxiety 3:", Result.PASSED, manualTest.apply(automationEngineer));
    }
    ...
    public void manualTestFailed() {
        ...
        Assert.assertEquals("Manual test by test engineer with GUI(9), instability 4, anxiety 1:", Result.FAILED, manualTest.apply(testEngineer));
    }
    ...
    public void automatedTestPassed() {
        ...
        AutomationEngineer automationEngineer = new AutomationEngineer();
        Assert.assertEquals("Automated test by automation engineer with API(3), instability 5, anxiety 1:", Result.PASSED, automatedTest.apply(automationEngineer));
    }
    ...
    public void automatedTestFailed() {
        ...
        TestEngineer testEngineer = new TestEngineer();
        Assert.assertEquals("Automated test by test engineer with API(3), instability 4, anxiety 3:", Result.FAILED, automatedTest.apply(testEngineer));
    }
}
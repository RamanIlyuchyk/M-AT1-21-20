...
public class ApplyTest {
    ...
    public void manualTestFailed() {
        ...
        Assert.assertEquals("Manual test by automation engineer with API(3), instability 4, anxiety 3:", Result.FAILED, manualTest.apply(automationEngineer));
    }
    ...
    public void automatedTestFailed() {
        ...
        TestEngineer testEngineer = new TestEngineer();
        Assert.assertEquals("Automated test by test engineer with GUI(9), instability 5, anxiety 3:", Result.FAILED, automatedTest.apply(testEngineer));
    }
    ...
    public void automatedTestPassed() {
        ...
        AutomationEngineer automationEngineer = new AutomationEngineer();
        Assert.assertEquals("Automated test by automation engineer with UNIT(1), instability 3, anxiety 1:", Result.PASSED, automatedTest.apply(automationEngineer));
    }
}